...
const catalogItems = [
  {
    ...
    features: [
      ...
      'Accesorios opcionales: anti-vuelco, apoyabrazos (fijos, ajustables o desmontables), elevador de reposapiés, protector lateral del asiento'
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Estructura rígida de acero con recubrimiento en polvo para mayor resistencia",
      "Ruedas traseras: 24” x 1.75” (47-507) con neumático",
      "Ruedas delanteras: 200 mm x 75 mm de caucho",
      'Incluye mochila con bomba, kit de parches, herramientas, repuestos y manual de usuario',
      "Accesorios opcionales: sistema anti-vuelco, apoyabrazos (ajustables, fijos o desmontables/giratorios), elevador de reposapiés, almohadilla lateral del asiento",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Reposapiés ajustable: en altura, ángulo y posición (adelante/atrás)",
      "Altura del asiento al suelo: 470, 490 o 510 mm",
      'Ruedas traseras: 24” x 1.75” (47-507) con neumáticos neumáticos',
      "Ruedas delanteras: 200 mm x 75 mm de caucho macizo", 
      'Incluye mochila con bomba de aire, kit de parches, herramientas, repuestos y manual de usuario',
      "Accesorios opcionales: sistema anti-vuelco, apoyabrazos (fijos, ajustables o abatibles), elevador de reposapiés, protector lateral del asiento",
    ],
